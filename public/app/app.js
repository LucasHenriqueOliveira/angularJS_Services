(function() {
    ...
    app.config(['booksProvider', 'constants', 'dataServiceProvider', '$routeProvider', '$logProvider', '$httpProvider', '$provide', function (booksProvider, constants, dataServiceProvider, $routeProvider, $logProvider, $httpProvider, $provide) {
